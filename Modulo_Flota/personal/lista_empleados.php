...
<head>
    ...
    <title>Modulo Flota | Personal</title>
</head>
...
<body>
    ...
    <!-- Contenido -->
    <main class="content">
        <?php require_once("componentes/tabla_personal.php") ?>
        <?php require_once("componentes/modal_actualizar_personal.php") ?>
        <?php require_once("componentes/modal_eliminar_personal.php") ?>
        <?php require_once("componentes/modal_agregar_personal.php") ?>
